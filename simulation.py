...
class SatelliteSimulator:
    ...
    def step(self) -> SatelliteTelemetry:
        ...
        sat_x = radius_km * (math.cos(raan_rad) * math.cos(theta) - math.sin(raan_rad) * math.sin(theta) * math.cos(inc))
        sat_y = radius_km * (math.sin(raan_rad) * math.cos(theta) + math.cos(raan_rad) * math.sin(theta) * math.cos(inc))
